This file explains how to upgrade from the (now very old!)
University of Delaware "Dropbox" package, to ZendTo.

As a ZendTo user, it is highly unlikely you will need this at all.

Note that the Delaware "Dropbox" is not to be confused with the
cloud storage service available from dropbox.com. They have no connection
whatsoever and are totally different things.
